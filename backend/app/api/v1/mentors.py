...
def get_mentor_students(
    ...
    # 1. Fetch all projects where mentor_id matches `id`
    ...
    # 2. Fetch all members of these projects (excluding the mentor themselves)
    ...
    # 3. Fetch unique User details for these students
    ...
    for student in students:
        # Find which of this mentor's projects this student is on
        ...
        # Get active sprint on that project
        latest_sprint = None
        if project_id:
        ...
        # Count tasks in progress (status != 'done') for this student in this active sprint
        tasks_in_progress = 0
        if sprint_id:
        ...
        # Get last activity date (based on latest submission timestamp or defaults to created_at)
        ...
        # Determine username slug for portfolio link
